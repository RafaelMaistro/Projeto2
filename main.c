            ...
            if (realizarLogin(fileBinUsuarios, &usuarioLogado)) {
                do {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        realizarEmprestimo(fileBinLivros, fileBinUsuarios, &usuarioLogado, emprestimos, &numEmprestimos);
                        break;
                    case 4:
                        devolverLivro(fileBinLivros, fileBinUsuarios, &usuarioLogado, emprestimos, &numEmprestimos);
                        break;
                    case 5:
